            ...
            $(this).find(".cta a").on("click", function(e) {
                ...
                $.ajax(startPath, {
                    ...
                    success: function(data) {
                        ...
                        $(questionHolder).append("<div id='" + theChain[0] + "' class='startNode dtNode active'><h3>" + data.question + "</h3>" + question_text + "<ul>" + startQuestions + "</ul></div>");
                    ...
                    $.ajax(jsonPath, {
                        ...
                        success: function(data) {
                            ...
                            if (endNode !== null) {
                                ...
                                $(questionHolder).append("<div id='" + theChain[theChain.length - 1] + "' class='dtNode active'><h3>" + data.question + "</h3>" + question_text + "<ul>" + dtQuestions + "</ul></div>");
                            ...
                            // this is an answer node
                                ...
                                $(questionHolder).append("<div id='" + theChain[theChain.length - 1] + "' class='dtNode answerNode'>" + answer_title + answer_image + data.description + "</div>");
